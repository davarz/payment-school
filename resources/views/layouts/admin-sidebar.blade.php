<!-- Sidebar -->
<div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-2xl border-r border-gray-100">
    <!-- Header -->
...
<!-- Top Bar -->
<div class="fixed top-0 right-0 left-64 z-40 bg-white shadow-sm border-b border-gray-200">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="flex items-center space-x-2 px-3 py-1.5 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <span class="text-sm font-medium text-blue-700">{{ $totalSiswa ?? 0 }} Siswa</span>
                </div>
            </div>
        </div>
    </div>
