...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Daftar pembayaran yang telah Anda lakukan</p>
    </div>
        ...
        <div class="p-6">
            @if($pembayaran->isEmpty())
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500">Pembayaran Anda akan muncul di sini setelah Anda melakukan transaksi</p>
                </div>
            @else
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <a href="{{ route('siswa.pembayaran.show', $item->id) }}" 
